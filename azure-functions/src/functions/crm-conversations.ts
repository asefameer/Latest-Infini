 ...
 *
 * All CRM conversation endpoints require admin authentication.
 *
 * Routes:
 *   GET    /api/crm/conversations            → list (supports ?status)  [admin]
 *   GET    /api/crm/conversations/:id         → get with messages       [admin]
 *   PUT    /api/crm/conversations/:id/status  → update status           [admin]
 *   POST   /api/crm/conversations/:id/messages → add message            [admin]
 */
