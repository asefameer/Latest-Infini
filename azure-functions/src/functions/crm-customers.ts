 ...
 *
 * Routes:
 *   GET    /api/crm/customers       → list (supports ?segment)      [admin]
 *   GET    /api/crm/customers/:id   → get by ID                     [admin]
 *   POST   /api/crm/customers       → create                       [admin]
 *   PUT    /api/crm/customers/:id   → update                       [admin]
 *   DELETE /api/crm/customers/:id   → delete                       [admin]
 */
